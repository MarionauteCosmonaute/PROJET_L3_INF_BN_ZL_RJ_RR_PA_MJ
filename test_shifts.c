...
int main ()
{
    ...
    int value = rand()%32;
    int shift_type= rand()%4;

    for(int opeCode=0; opeCode<16;opeCode++)
    {
        
        operation= squeleton | (opeCode <<21) | (shift_type<<5) | (value << 7);
        printf("OpCode = %d\n", opeCode );
        printf("shift type = %x\n",shift_type);
        printf("value = %d\n",value);

        // // On veut tester l'opeCode
        // printf("Choisir valeur opeCode: (entre 0 et 15)\n");
        // uint32_t opeCode;
        // scanf("%d", &opeCode); //En attendant le full aléatoire
        // uint32_t masque = 4279238655; // FFOFFFFF 1111 1111 0000 1111 1111 1111 1111 1111
        // operation = operation & masque;
        // opeCode = opeCode<<21;
        // operation = operation | opeCode;
        // //printf("nb = %u\n", operation);


        // // On veut tester la condition
        // printf("Choisir la condition à tester: (entre 0 et 15)\n");
        // uint32_t cond;
        // scanf("%d", &cond);
        // uint32_t masque2 = 268435455; // fffffff 0000 1111 1111 1111 1111 1111 1111 1111
        // operation = operation & masque2;
        // cond = cond<<28;
        // operation = operation | cond;
        // //printf("nb = %u\n", operation);

        // operation = 3759149058; // 1110 000(0 000)1 0000 0001 0000 0000 0010


        int bit_I = get_bit(operation,25);
